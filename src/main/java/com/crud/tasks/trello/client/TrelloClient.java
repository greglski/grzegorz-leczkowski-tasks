...
public class TrelloClient {
    ...
    private URI getUri() {
        ...
        URI url = UriComponentsBuilder.fromHttpUrl(trelloApiEndpoint + "/members/grzegorzleczkowski/boards")
    ...
    public List<TrelloBoardDto> getTrelloBoards() {
        ...
        return Arrays.stream(boardsResponse).collect(Collectors.toList());
